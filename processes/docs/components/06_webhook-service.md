...
| MO                | mo.contract.delivered.to.oem | "Successfully delivery of the Contract Data. The Contract Data with the given EMAID got either:
- Pulled from the OEM Backend
- Installed over EVSE (certificateInstallationRequest)" | "Signed Contract Certificate Bundle successfully delivered to OEM or CPO-Backend" |
...
| OEM               | oem.contract.deleted | Info to OEM Backend about the deletion of a Contract Data in CCP. | "Deleted contract for PCID…. With EMAID…" |
